...
const Sidebar = ({
  ...
  return (
    <>
      {/* Mobile Overlay */}
      <div
        className={`fixed inset-0 z-30 bg-slate-950/40 backdrop-blur-[2px] transition-all duration-300 md:hidden ${open
      ...
      >
        <div className="flex h-full flex-col px-4 py-5">
          ...
          {/* Header */}
          <div
            className={`flex shrink-0 items-center ${collapsed
                ? 'justify-center'
                : 'justify-between'
              }`}
          >
            ...
            >
              {/* Logo */}
              {collapsed ? (
                <div className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-white shadow-lg shadow-blue-500/20">
                  <img
                    src="/final_logo.png"
                    alt="Apna India logo"
                    ...
                    <div key={item.label} className="flex flex-col gap-1" >
                      ...
                      >
                        ...
                        {!collapsed && (
                          <ChevronRight
                            size={15}
                            className={`shrink-0 transition-transform ${salesMenuOpen
                                ? 'rotate-90'
                                : ''
                              }`}
                          />
